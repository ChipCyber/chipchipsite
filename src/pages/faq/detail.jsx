...
import { knowledgePageListApi,knowledgeGetApi } from "../../api"
...
export default function Index() {
    ...
    useEffect(() => {
        knowledgePageListApi({pageIndex:1,pageSize:10}).then(({data})=>{
            setList(data);
        });
    }, []);
    useEffect(() => {
            ...
            <Root>
                ...
                <Content>
                    <Left>
                        ...
                        {/* <Source>{data?toDateStr(data.publishTime):''}</Source> */}
