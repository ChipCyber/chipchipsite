...
export function getHeader() {
  return { 'Content-Type': 'application/json; charset=UTF-8', 'Accept-Language': LanaguageRequestMap[i18n.language] ?? LanaguageRequestMap['en'] };
}

const service = axios.create({
  baseURL: process.env.REACT_APP_MINT_URL,
  timeout: 30000
})
